...
ai-training-026/
│
├── Week1_AI_Foundations/
├── Week2_Python_Basics/
├── Week3_Data_Handling/
├── Week4_GenAI_NLP/
├── Week5_Prompt_Engineering/
├── Week6_Apps_RAG/
│
├── Assignments/
├── Projects/
...
```text
Assignment_Week1_Name.pdf
Assignment_Week2_Name.ipynb
```
...
Students will build a complete AI-powered application using:
